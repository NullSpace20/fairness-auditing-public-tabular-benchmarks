# File manifest — Public Repository Release Package
...
| `figures/` | Figures | Manuscript figures (PDF + PNG) |
| `revision_robustness/` | Processed results | R2A/R2B/R2C sensitivity CSVs and figures |
| `manifests/` | Processed results | Configuration manifest and validation |
| `code/` | Code | Post-processing and revision-analysis scripts |

Raw Adult, UCI Bank, and ACS/Folktables data files are intentionally absent.
